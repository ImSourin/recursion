...
(function (root, factory) {
    ...
    */
    ...
    number (integer) between 1 and max.
    */
    var randomNoRepeat = function (key, max) {
        var num = 0,
    ...
    */
    var randomJitter = function (number, jitter) {
        if (jitter <= 1) {
            return number;
        }
    ...
    */
    ...
    key - a string
    */
    var resetIterator = function (key) {
        _iterators[key] = 0;
    };
    ...
    */
    ...
    an entry from a random position in arr.
    */
    var oneOfNoRepeat = function (key, arr) {
    ...
    a string
    */
    var listWriter = function listWriter(_stringList, _separator, _wrapper) {
    ...
    */
    var safeAdd = function (num, val, max, min) {
    ...
    var safeOp = function (num, val, op, min, max) {
        if (typeof num !== "number" || typeof val !== "number" ||
    ...
    */
    var isOneOf = function (base, options) {
        var b = "",
            option = "";
    ...
    */
    var haveSameContents = function (arr1, arr2) {
        var i = 0,
            checklist = [];
    ...
    */
    var remap = function (val, oldRangeL, oldRangeU, newRangeL, newRangeU) {
...
// Returns a number as a spelled-out equivalent, like 20 --> twenty, for any number up to 9999. Four-digit numbers are printed like years (nineteen fifty-six). Return a string unchanged.
    var printedNumber = function (num) {
    ...
    */
    ...
    var assert = function (condition, messageIfFalse) {
        if (condition) {
            console.log("Passed");
        } else {
    ...
    var objToText = function (obj, indentLevel) {
