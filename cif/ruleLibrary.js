...
(function(root, factory) {
    if (typeof define === "function" && define.amd) {
        define(['require', 'sfdb', 'volition', 'underscore', 'util', 'log', 'test'], factory);
    ...
    var areRulesEqual = function (rule1, rule2) {
        ...
        if (rule1.conditions === undefined && rule2.conditions !== undefined || rule1.conditions !== undefined && rule2.conditions === undefined) {
            //one of these rule has a condition set, adn the other one doesn't. not equal! return false!
            return false;
        }
        if (rule1.effects === undefined && rule2.effects !== undefined || rule1.effects !== undefined && rule2.effects === undefined) {
    ...
    var predicateToEnglish = function (pred) {
        ...
        resultObj.text = result.map(function (r) {
            return r.text;
        })
            .filter(function (n) {
                return n != ""
